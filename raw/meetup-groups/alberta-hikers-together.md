...
> Alberta Hikers Together group info.

<card-group>
<card icon="i-lucide-link" target="_blank" title="Access Group" to="https://www.facebook.com/groups/406674690939732">

Access the group.

</card>

<card icon="i-material-symbols-rule" target="_blank" title="Group Rules" to="https://www.facebook.com/groups/406674690939732/about">
...
Understand how this group relates to [other meetup groups](/meetup-groups). More specifically:

- Check out the [Meetup Groups](/meetup-groups) page to understand the similarities and differences with other meetup groups.
- There are better groups to ask information about [hiking trails, conditions, trail closures, bear attacks](/hiking-scrambling-beta), etc.
...
Posting pictures / trip reports is especially encouraged for people who post their hike plans in the group, since it helps to build excitement for upcoming trips. [Inspirational Groups](/hiking-scrambling-beta) and groups providing [practical information](/hiking-scrambling-beta) are a better match for those who want to share photos of past adventures without organizing a hike.
