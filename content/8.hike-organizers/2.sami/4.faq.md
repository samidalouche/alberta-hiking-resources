...
Everything I get asked most, in one place. For the bigger picture, these two pages set the scene:
...
::card-group
  ...
  ---
  How I like to run relaxed, flexible multi-day trips — do your own thing by day, together at night.
  :::
...
## 🤷 I want to join a hike but can't commit just yet…
...
"Smoky" is a bit vibes-based, though, so here's my actual line in the sand 🧮:
- 🫁 **PM2.5 under 5 µg/m³** — that's my personal happy zone for fine particulate matter.
- 🟢 **CAQI under 50** — the [Common Air Quality Index](https://en.wikipedia.org/wiki/Air_quality_index#CAQI) sitting comfortably in the low band.

More than that, and I'm out — I'm not hiking. 🚫🥾 It's a personal threshold, not medical advice, but those two numbers are how I make the call. When in doubt, I'd rather save the lungs for a bluebird day. 💙🏔️
